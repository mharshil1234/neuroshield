...
export default function SetupQ3() {
  const navigate = useNavigate();
  const { answers, updateAnswer } = useOnboarding();
  const [selected, setSelected] = useState(answers.struggles || []);
        ...
        <div className="w-full bg-white rounded-[28px] px-8 pt-6 pb-7 shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative z-10">
          ...
          <div className="mb-6">
            ...
            <div className="w-full h-[6px] bg-[#E5EBE6] rounded-full overflow-hidden">
              <div className="h-full bg-[#6B8E73] rounded-full transition-all" style={{ width: '100%' }} />
            </div>
          </div>
          ...
          <div className="text-center mb-5">
            ...
            <p className="text-[#8FA898] text-[12px]">
              This helps us tailor strategies — from task breakdowns to focus timers.
            </p>
          </div>
